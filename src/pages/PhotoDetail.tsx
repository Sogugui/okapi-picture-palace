    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-amber-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <h1 className="text-3xl font-bold text-amber-900 mb-4">Photo Not Found</h1>
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-amber-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Content */}
          <div>
            <h1 className="text-3xl font-bold text-amber-900 mb-4">{photo.title}</h1>
            <p className="text-xl text-gray-600 mb-6 italic">{photo.caption}</p>
            
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <h2 className="text-xl font-semibold text-amber-900 mb-3">About This Photo</h2>
              <p className="text-gray-700 leading-relaxed">{photo.description}</p>
            </div>
            
            <div className="bg-amber-50 p-6 rounded-lg mb-6">
              <h3 className="text-lg font-semibold text-amber-900 mb-3">Photo Details</h3>
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-green-900 mb-3">Did You Know?</h3>
